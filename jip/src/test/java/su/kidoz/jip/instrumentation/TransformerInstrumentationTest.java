...
public class TransformerInstrumentationTest {
    private static final String FIXTURE_BINARY_NAME =
            "su.kidoz.jip.testfixtures.TransformFixture";
    private static final String FIXTURE_INTERNAL_NAME =
            "su/kidoz/jip/testfixtures/TransformFixture";
    ...
    public void instrumentsConstructorsAndMethodReturns() throws Exception {
        ...
        assertEquals(Arrays.asList(
                "alloc:" + FIXTURE_INTERNAL_NAME,
                "start:" + FIXTURE_INTERNAL_NAME + "#<init>",
                "end:" + FIXTURE_INTERNAL_NAME + "#<init>",
                "start:" + FIXTURE_INTERNAL_NAME + "#echo",
                "end:" + FIXTURE_INTERNAL_NAME + "#echo"
        ), TestProfiler.events());
    }
    ...
    public void recordsUnwindWhenExceptionHandlerRuns() throws Exception {
        ...
        assertEquals(Arrays.asList(
                "start:" + FIXTURE_INTERNAL_NAME + "#catchesException",
    ...
    public void recordsMethodExitWhenExceptionEscapes() throws Exception {
        ...
        assertEquals(Arrays.asList(
                "start:" + FIXTURE_INTERNAL_NAME + "#throwsException",
                "end:" + FIXTURE_INTERNAL_NAME + "#throwsException"
        ), TestProfiler.events());
    }
    ...
    public void instrumentsThreadSleepCalls() throws Exception {
        ...
        assertEquals(Arrays.asList(
                "start:" + FIXTURE_INTERNAL_NAME + "#sleepBriefly",
                "beginWait:" + FIXTURE_INTERNAL_NAME + "#sleepBriefly",
                "endWait:" + FIXTURE_INTERNAL_NAME + "#sleepBriefly",
                "end:" + FIXTURE_INTERNAL_NAME + "#sleepBriefly"
        ), TestProfiler.events());
    }
    ...
    private static Class<?> loadTransformedFixture() throws Exception {
        ByteArrayClassLoader loader = new ByteArrayClassLoader(
                TransformerInstrumentationTest.class.getClassLoader(),
                FIXTURE_BINARY_NAME
        );
        byte[] original = readFixtureBytes();
        byte[] transformed = new Transformer().transform(
                loader,
                FIXTURE_INTERNAL_NAME,
                null,
                null,
                original
        );
    ...
    private static byte[] readFixtureBytes() throws IOException {
        ...
        try (InputStream inputStream =
                     TransformerInstrumentationTest.class.getClassLoader().getResourceAsStream(resource)) {
            if (inputStream == null) {
